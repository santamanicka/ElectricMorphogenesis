...
numSamples=11
numSimIters=100
analysisMode="fixWeightBiasSweepScreenGJ"
StartFileNumber=0
EndFileNumber=5
...
do
  python analyzeCellularFieldNetwork.py --latticeDims $latticeDims --fieldResolution $fieldResolution --fieldAggregation $fieldAggregation --fieldScreenSize $fieldScreenSize --fieldTransductionWeight $fieldTransductionWeight --fieldTransductionBias $fieldTransductionBias --GJStrength $GJStrength --randomizeInitialStates $randomizeInitialStates --numSamples $numSamples --numSimIters $numSimIters --analysisMode $analysisMode --fileNumber $fileNumber --verbose $verbose
done
