...
#sbatch --export=ALL,fieldResolution=1,fieldAggregation=average,fieldScreenSize=4,GJStrength=0.25,clampMode=fieldDomeTwoFoldSymmetry,clampType=oscillatory,verbose=False --time 2-00:00:00 -p batch --array 501-600 -e Error_%A_%a.err --mem 4G runLearnCellularFieldNetwork.sh
