...
#sbatch --export=ALL,clampMode=fieldDomeTwoFoldSymmetry,clampType=oscillatory --time 2-00:00:00 -p batch --array 201-300 -e Error_%A_%a.err --mem 4G runLearnCellularFieldNetwork.sh
