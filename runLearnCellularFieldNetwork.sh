...
#sbatch --export=ALL,GJStrength=0.05,clampMode=tissueDomeLigandTwoFoldSymmetry,clampType=oscillatory,clampDurationProp=0.1,numSimIters=1000,numLearnIters=50000,verbose=False --time 2-00:00:00 -p batch --array 1801-1900 -e Error_%A_%a.err --mem 4G runLearnCellularFieldNetwork.sh
