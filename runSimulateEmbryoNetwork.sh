#!/bin/bash
dims=$1
python simulateEmbryoNetwork.py --dims $dims --teratogenExposure $teratogenExposure --modelNumEmbryo $modelNumEmbryo --modelNumATP $modelNumATP --nsamples $nsamples --niters $niters --sampleNumber $SLURM_ARRAY_TASK_ID --save $save
