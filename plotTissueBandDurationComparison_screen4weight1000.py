"""PolyPatterning_Sim.md Sec 11.11: hold duration at depth 3 for the band-limited static hold
(tissueBandGpolTwoFoldSymmetry, screen4/weight1000) -- 100, 300 and 500 iterations (200 was only
ever run at depth 7, not depth 3, so it is not part of this series). Fixed, final figure --
...
classes = [
    ...
    ('depth 3, 300-iter hold', [1443,1444,1445,1446,1447,1448], [1449,1450,1451,1452,1453,1454]),
    ('depth 3, 500-iter hold', [1455,1456,1457,1458,1459,1460], [1461,1462,1463,1464,1465,1466]),
]
...
fig.suptitle('Tissue-band static hold, hold duration at depth 3 (30x30, screen4/weight1000)', fontsize=12)
fig.tight_layout()
fig.savefig('figures/tissueBandDurationComparison_screen4weight1000.png', dpi=140, bbox_inches='tight')
print('wrote figures/tissueBandDurationComparison_screen4weight1000.png')
